...
using DSAWithC_.DataStructures.LinkedList.Questions;
...
namespace DSAWithC_.DataStructures.LinkedList
{
    public class LinkedList
    {
        public void RunAll()
        {
            ...
            // bool found = LLQuestions.Search(head, 40);
            // Console.WriteLine(found);

            // int count = LLQuestions.NodeCounter(head);
            // Console.WriteLine(count);
            // int countO = LLQuestions.SameOccureance(head, 20);
